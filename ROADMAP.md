...
1. **Build first:** ~~Phase 0's correctness fixes~~ — done (2026-08-16). ~~Phase 1 (Guardian, real grade/fee logic)~~ — done (2026-08-16). ~~Phase 2 (real scheduling/notifications, Subject/Curriculum, Timetable)~~ — done (2026-08-16). ~~Phase 3 (admissions saga, bulk roster import, report card PDFs)~~ — done (2026-08-16). ~~Phase 4 (multi-campus rollup reporting)~~ — done (2026-08-17), see Development Roadmap above. Next: Phase 5+ P2 modules, on demand only.
