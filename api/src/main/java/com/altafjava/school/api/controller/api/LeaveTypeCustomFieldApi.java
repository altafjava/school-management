...
@Tag(name = "Leave Type Custom Field", description = "APIs for managing Leave Type Custom Field operations.\n\n**Tenant Scope**: All endpoints are tenant-scoped via X-Tenant-ID header.\n**Auth**: JWT Bearer token required on all endpoints unless marked public.")
@SecurityRequirement(name = "bearerAuth")
@SecurityRequirement(name = "tenantHeader")
public interface LeaveTypeCustomFieldApi {

	@Operation(summary = "Get", operationId = "leavetypecustomfield_get")
	public ApiResponse<List<CustomFieldValueResponse>> get(@PathVariable String publicId);

	@Operation(summary = "Set", operationId = "leavetypecustomfield_set")
