...
import com.altafjava.school.api.controller.api.GuardianCustomFieldApi;
...
public class GuardianCustomFieldController implements GuardianCustomFieldApi {
	...
	public ApiResponse<List<CustomFieldValueResponse>> get(@PathVariable String publicId) {
		...
		return ApiResponse.success(customFieldValueMapper
				.toResponseList(
						customFieldValueService.getAllValues(CustomFieldEntityType.GUARDIAN, guardian.getId())));
	}
