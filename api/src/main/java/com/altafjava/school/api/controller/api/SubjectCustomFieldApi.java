...
@Tag(name = "Subject Custom Field", description = "APIs for managing Subject Custom Field operations.\n\n**Tenant Scope**: All endpoints are tenant-scoped via X-Tenant-ID header.\n**Auth**: JWT Bearer token required on all endpoints unless marked public.")
@SecurityRequirement(name = "bearerAuth")
@SecurityRequirement(name = "tenantHeader")
public interface SubjectCustomFieldApi {

	@Operation(summary = "Get", operationId = "subjectcustomfield_get")
	public ApiResponse<List<CustomFieldValueResponse>> get(@PathVariable String publicId);

	@Operation(summary = "Set", operationId = "subjectcustomfield_set")
