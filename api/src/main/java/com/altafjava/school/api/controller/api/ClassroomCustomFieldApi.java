...
@Tag(name = "Classroom Custom Field", description = "APIs for managing Classroom Custom Field operations.\n\n**Tenant Scope**: All endpoints are tenant-scoped via X-Tenant-ID header.\n**Auth**: JWT Bearer token required on all endpoints unless marked public.")
@SecurityRequirement(name = "bearerAuth")
@SecurityRequirement(name = "tenantHeader")
public interface ClassroomCustomFieldApi {

	@Operation(summary = "Get", operationId = "classroomcustomfield_get")
	public ApiResponse<List<CustomFieldValueResponse>> get(@PathVariable String publicId);

	@Operation(summary = "Set", operationId = "classroomcustomfield_set")
